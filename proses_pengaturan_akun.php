...
if ($aksi == 'update_foto') {
    ...
    $nama_petugas = $_SESSION['nama_lengkap'];
    $id_inst_user = $_SESSION['id_instansi'];
    kirim_notif_ke_admin_instansi($koneksi, $id_inst_user, $id_user, "Pengajuan Perubahan Akun", "Petugas ($nama_petugas) mengajukan perubahan data diri.", "akun_pengajuan");
